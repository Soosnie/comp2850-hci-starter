...
**Calculation**: (number of successes) / (number of attempts)
...
**Example**: T1 (filter): Median 24s, MAD 6s, Range 12s-58s (n=8)
...
**Calculation**: (number of validation_error events) / (total number of events)
...
**Example**: T3(Add task): Error rate: 2/5 = 40%, Errors: 1 x blank title, 1x exceeded max length
...
**Example**: T2(Edit): Mean errors per participant: 0.4 (2 errors across 5 participants)
...
**Example**: T1(Filter): Mean confidence 4.2 +- 0.8, Distribution: 0x1 0x2 0x3 1x3 2x4 2x5
